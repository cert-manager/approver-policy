...
require (
	github.com/cert-manager/cert-manager v1.10.0-beta.0
...
replace (
	// Required from
	// https://github.com/cert-manager/cert-manager/blob/6947696b12428a1f9e5823c2e69de84b8dd08c1c/go.mod#L252
