...
func (in *CertificateRequestPolicyAllowed) DeepCopyInto(out *CertificateRequestPolicyAllowed) {
	*out = *in
	...
	if in.OtherNames != nil {
		...
		*out = make([]CertificateRequestPolicyAllowedOtherName, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertificateRequestPolicyAllowedOtherName) DeepCopyInto(out *CertificateRequestPolicyAllowedOtherName) {
	*out = *in
	if in.Values != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertificateRequestPolicyAllowedOtherName.
func (in *CertificateRequestPolicyAllowedOtherName) DeepCopy() *CertificateRequestPolicyAllowedOtherName {
	if in == nil {
		return nil
	}
	out := new(CertificateRequestPolicyAllowedOtherName)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertificateRequestPolicyAllowedSubjectOtherAttribute) DeepCopyInto(out *CertificateRequestPolicyAllowedSubjectOtherAttribute) {
	*out = *in
	if in.Values != nil {
		in, out := &in.Values, &out.Values
		*out = new([]string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertificateRequestPolicyAllowedSubjectOtherAttribute.
func (in *CertificateRequestPolicyAllowedSubjectOtherAttribute) DeepCopy() *CertificateRequestPolicyAllowedSubjectOtherAttribute {
	if in == nil {
		return nil
	}
	out := new(CertificateRequestPolicyAllowedSubjectOtherAttribute)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CertificateRequestPolicyAllowedX509Subject) DeepCopyInto(out *CertificateRequestPolicyAllowedX509Subject) {
	*out = *in
	...
	if in.OtherAttributes != nil {
		in, out := &in.OtherAttributes, &out.OtherAttributes
		*out = make([]CertificateRequestPolicyAllowedSubjectOtherAttribute, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
